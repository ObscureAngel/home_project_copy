...
if(!array_key_exists('message', $_POST) || $_POST['message'] == '') {
	$errors ['message'] = "Vsous n'avez pas renseigné votre message";
}
if(!array_key_exists('antispam', $_POST)) {// on place un petit filet anti robots spammers
	$errors ['antispam'] = "Vous êtes un robots";
}
...
if(!empty($errors)) { // si erreur on renvoie vers la page précédente
	...
	$to = 'support@isn-racing.comoj.com'; // Insérer votre adresse email ICI
